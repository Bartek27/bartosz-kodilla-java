...
public class TaskFactoryTestSuite {
    ...
    public void testFactoryDrivingTask() {
        ...
        //Then
        Assert.assertEquals("Jade", drivingTask.getTaskName());
    ...
    public void testFactoryShoppingTask() {
        ...
        //Then
        Assert.assertEquals("Kupuje bulki", shoppingTask.getTaskName());
    ...
    public void testFactoryPaintingTask() {
        ...
        //Then
        Assert.assertEquals("Maluje dom", paintingTask.getTaskName());
